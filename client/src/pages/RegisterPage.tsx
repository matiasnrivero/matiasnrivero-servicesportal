      ...
      <div className="flex flex-col items-center gap-6 max-w-md w-full px-4">
        ...
        <Card className="w-full">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl" data-testid="text-register-heading">Create Account</CardTitle>
            <CardDescription data-testid="text-register-description">Start managing your artwork services</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <Button type="submit" disabled={isLoading} className="w-full" data-testid="button-create-account">
