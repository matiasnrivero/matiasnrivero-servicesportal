      ...
      <div className="flex flex-col items-center gap-6 max-w-md w-full px-4">
        ...
        <Card className="w-full">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl" data-testid="text-login-heading">Welcome Back</CardTitle>
            <CardDescription data-testid="text-login-description">Sign in to your account</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <a
                  ...
                  className="text-sm text-sky-blue-accent hover:underline self-end"
                  data-testid="link-forgot-password"
                >
                  Forgot password?
                </a>
              </div>
              <Button type="submit" disabled={isLoading} className="w-full" data-testid="button-sign-in">
              ...
              <p className="text-sm text-muted-foreground text-center">
                ...
                <a
                  ...
                  className="text-sky-blue-accent hover:underline"
